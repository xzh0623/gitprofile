...
const CONFIG = {
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['BioTechCo/main_project','xzh0623/TWB_HearingLoss', 'xzh0623/NLP/tree/main/Term%20Project','xzh0623/ca2024f','xzh0623/gitprofile','xzh0623/StonePet-Haven'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
  //   external: {
  //     header: 'My Projects',
  ...
  resume: {
    fileUrl:
      'https://drive.google.com/file/d/1LWjD56HDiyf0ddcjU_iIhe_Ln1BlmOiE/view?usp=sharing', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'SQL',
    'Python',
  ...
  publications: [
    {
      ...
      link: 'https://drive.google.com/file/d/1_rMTIevKvNlk7yg97SqOfsGfZ0l49Shn/view?usp=sharing',
      // description:
